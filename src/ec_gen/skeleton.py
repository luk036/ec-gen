...
from ec_gen import __version__
...
# `from ec_gen.skeleton import fib`,
...
def main(args: list[str]) -> None:
    ...
    print(f"The {namespace.n}-th Fibonacci number is {fib(namespace.n)}")
