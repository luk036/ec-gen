...
bench(
    "emk_comb_gen(16,5)", lambda: sum(1 for _ in emk_comb_gen(16, 5)) + 1, comb(16, 5)
)
bench(
    "emk_comb_gen(10,5)", lambda: sum(1 for _ in emk_comb_gen(10, 5)) + 1, comb(10, 5)
)
...
bench(
    "set_partition(11,5)",
    lambda: sum(1 for _ in set_partition(11, 5)) + 1,
    stirling2nd(11, 5),
)
bench(
    "set_partition(8,4)",
    lambda: sum(1 for _ in set_partition(8, 4)) + 1,
    stirling2nd(8, 4),
)
